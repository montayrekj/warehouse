        ...
        <card type="chart">
            ...
            <span class="simple-text logo-mini">
              <div class="logo-img">
                <!--img
                  ...
                  alt="" style="height: 50px; position: relative; left: 45%; margin-bottom: 20px;"-->
                <img
          ...
          <div style="padding: 15px">
            <form>
              ...
              <button slot="button" @click="login" class="btn btn-sm btn-success" style="width: 100%; margin-top: 20px; height: 40px;">Login</button>
            </form>
          </div>
        </card>
      </div>
